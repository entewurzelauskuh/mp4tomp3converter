...
class ConversionService : Service() {
    ...
    private suspend fun runDrain() {
        ...
        try {
            ...
            // Re-check after each pass: jobs enqueued during the final iteration are picked up
            // here rather than orphaned by a service that already decided to stop.
            do {
                drainer.drainQueue()
            } while (repository.nextQueued() != null)
        } finally {
            draining.set(false)
